...
function DataAnalyticsPractice() {
  ...
  const loadQuestions = () => {
    const randomQuestions = getRandomQuestions("data-analytics", 10);
    ...
    <div className="practice-container">
      ...
      <div className="practice-header">
        <div className="header-left">
          <div className="header-title">Data Analytics 📈</div>
...
export default DataAnalyticsPractice;
