...
function DSAPractice({ language }) {
    ...
    if (allAnswered) {
      ...
      navigate("/Result", {
        state: {
          ...
          language: language === "dsa-java" ? "DSA Java" : language === "dsa-python" ? "DSA Python" : "DSA C++",
          answers,
        },
      });
    }
  ...
  const langName = language === "dsa-java" ? "DSA - Java" : language === "dsa-python" ? "DSA - Python" : "DSA - C++";
    ...
    <div className="practice-container">
      ...
      <div className="practice-header">
        <div className="header-left">
          <div className="header-title">{langName} 📊</div>
